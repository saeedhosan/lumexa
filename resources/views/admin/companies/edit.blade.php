<x-layouts::app title="Edit Company">
    ...
    <div class="max-w-2xl">
        ...
        <flux:subheading class="mb-6">Update company information.</flux:subheading>
        ...
        <form method="POST" action="{{ route('admin.companies.update', $company) }}">
            ...
            <div class="space-y-6">
                ...
                <flux:field>
                    ...
                    >{{ old('description', $company->description) }}</flux:textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <flux:field>
                        ...
                        <flux:select name="country" value="{{ old('country', $company->country ?? 'US') }}">
                    ...
                    <flux:field>
                        ...
                        <flux:select name="language" value="{{ old('language', $company->language ?? 'en') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <flux:field>
                        ...
                        <flux:select name="timezone" value="{{ old('timezone', $company->timezone ?? 'UTC') }}">
                    ...
                    <flux:field>
                        ...
                        <flux:select name="currency" value="{{ old('currency', $company->currency ?? 'USD') }}">
